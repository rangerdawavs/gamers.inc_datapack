...
execute if score @s core_enchant matches 9 if items entity @s weapon.offhand *[enchantments~[{enchantments:protection,levels:2}]] if score @s core_leggings_protection matches 12.. run item modify entity @s weapon.offhand enchanted_core:add_protection
...
execute if score @s core_enchant matches 10 if items entity @s weapon.offhand *[enchantments~[{enchantments:blast_protection,levels:2}]] if score @s core_leggings_blast_protection matches 12.. run item modify entity @s weapon.offhand enchanted_core:add_blast_protection
...
execute if score @s core_enchant matches 11 if items entity @s weapon.offhand *[enchantments~[{enchantments:fire_protection,levels:2}]] if score @s core_leggings_fire_protection matches 12.. run item modify entity @s weapon.offhand enchanted_core:add_fire_protection
...
execute if score @s core_enchant matches 12 if items entity @s weapon.offhand *[enchantments~[{enchantments:projectile_protection,levels:2}]] if score @s core_leggings_projectile_protection matches 12.. run item modify entity @s weapon.offhand enchanted_core:add_projectile_protection
