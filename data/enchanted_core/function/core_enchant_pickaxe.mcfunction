...
execute if score @s core_enchant matches 1 if items entity @s weapon.offhand *[custom_data~{"core_enchanted_temp":1b}] run scoreboard players remove @s core_pickaxe_unbreaking 1
#efficiency
...
execute if score @s core_enchant matches 2 if items entity @s weapon.offhand *[custom_data~{"core_enchanted_temp":1b}] run scoreboard players remove @s core_pickaxe_efficiency 1
#fortune
...
execute if score @s core_enchant matches 3 if items entity @s weapon.offhand *[custom_data~{"core_enchanted_temp":1b}] run scoreboard players remove @s core_pickaxe_fortune 1
#silk touch
