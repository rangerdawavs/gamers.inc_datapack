...
scoreboard players operation @s custom_food.temp -= @s custom_food.count
$execute store result storage custom_food:stored_bundle_contents data."minecraft:bundle_contents".[$(value)].count int 1 run scoreboard players get @s custom_food.temp
