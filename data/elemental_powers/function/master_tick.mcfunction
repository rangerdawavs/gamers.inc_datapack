...
execute as @a[tag=water_type] run scoreboard players enable @s channel_depth_strider
execute as @a[tag=fire_type] run scoreboard players enable @s channel_fire_aspect
