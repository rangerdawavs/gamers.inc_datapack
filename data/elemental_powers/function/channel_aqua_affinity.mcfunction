...
execute unless entity @s[nbt={SelectedItem:{components:{"minecraft:lore":['"water type"']}}}] run item modify entity @s weapon.mainhand elemental_powers:add_water_type_lore_tag
