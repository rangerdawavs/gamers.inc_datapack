...
execute unless entity @s[nbt={SelectedItem:{components:{"minecraft:lore":['"fire type"']}}}] run item modify entity @s weapon.mainhand elemental_powers:add_fire_type_lore_tag
