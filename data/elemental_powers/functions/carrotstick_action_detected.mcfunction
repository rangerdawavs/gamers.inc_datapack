...
execute if entity @s[tag=electric_type] if score @s elemental_level matches 4.. if entity @s[nbt={SelectedItem:{tag:{CustomModelData:8}}}] run function elemental_powers:active_electric_type_lightningstorm_strike_activated
