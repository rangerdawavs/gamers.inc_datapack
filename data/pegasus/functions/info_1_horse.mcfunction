...
execute store result score @s horse_jump run data get entity @e[type=horse,distance=..3,sort=nearest,limit=1] Attributes[{Name:"minecraft:horse.jump_strength"}].Base 100
